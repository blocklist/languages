...
<table border="1">
  ...
  <tr>
    ...
    <td>
     Apache, RFI, w00tw00t, SQL-Injection + <a href="http://honeystats.info/glastopf_rbldnsd.zone" title="IP-List from honeystats.info (RFI-Attacken)">http://honeystats.info/</a>
    </td>
  </tr>
  <tr>
    <td>
