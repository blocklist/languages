          ...
          <div class="menuhead">Select Language:</div>
            <div class="menu_content">
              ...
              <a href="{$langlinknl}" title="Nederlands: activated">
			    <img src="/templates/css/haken.gif" alt="Nederlands: activated" border="0" style="background-image:url('/templates/css/k_nl.jpg'); background-position: center;" />
              </a>
...
<input type="image" src="/templates/images/en_btn_donate_SM.gif" name="submit" alt="donate for blocklist with PayPal." />
</form>
<br />
