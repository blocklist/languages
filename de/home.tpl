...
Jeden Tag kommen weitere Server/Partner (aktuell &uuml;ber {$currentusers} User) dazu, welche uns Reports zukommen lassen, damit diese anonymisiert und automatisch an die Provider der Angreifer versendet werden k&ouml;nnen.
