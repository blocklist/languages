          ...
          <div class="menuhead">Sprachauswahl:</div>
           ...
           <div class="menuhead">n&uuml;tzliche Links:</div>
            ...
            <span>
            aktuell gelistete IP's: {$blockt}
            </span>
            <br />
            <br />

            <strong>N&uuml;tzliche Links:</strong>
            <br />
            <ul style="margin-left: -16px">
			  ...
			  <li><a href="https://de.wordpress.org/plugins/reportattacks/" title="Wordpress Plugin ReportAttacks">Wordpress Plugin ReportAttacks</a></li>
...
<input type="image" src="/templates/images/de_btn_donate_SM.gif" name="submit" alt="donate for blocklist with PayPal." style="width:150px; height:37px" />
</form>
