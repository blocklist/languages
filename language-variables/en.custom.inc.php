...
$langs['search_takealook'] = 'Please take also a look to <a href="http://honeystats.info/glastopf_rbldnsd.zone" title="Honeystats.info RFI-Attacks&quot">http://honeystats.info/</a> if your Search returns no matches.';
$langs['insert_email'] = 'Please insert an abuse-address';
$langs['insert_emailnotyour'] = 'The Address is already used by another User';
...
$langs['replace_notyou'] = 'The entry does not belong to your user.';
...
$langs['delist_sucess'] = 'IP marked as fixed and cleaned and deleted from the download-list (in the next 60 Minutes).';
...
$langs['utitle_register.block'] = 'Registration step 2 from 2 (blocking)';
...
$langs['utitle_profile_reports'] = 'daily-/weekly-/monthly- summary Reports.';
